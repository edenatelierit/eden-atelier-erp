...
export function UserFormPanel({
  ...
  return (
    <InlineFormPanel
      ...
      title={isEditing ? t("admin.editUser") : t("admin.addUser")}
    ...
    >
      <Form id="user-form" form={form} onSubmit={onSubmit} className="space-y-4">
        <FieldGroup>
          <FormGrid>
            <FormField
              span="medium"
            ...
            <FormField span="medium" data-invalid={!!form.formState.errors.role}>
...
/** @deprecated Use UserFormPanel */
export const UserFormDialog = UserFormPanel;
